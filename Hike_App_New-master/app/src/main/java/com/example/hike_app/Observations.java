...
public class Observations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addObs = dialog.findViewById(R.id.obsadd);
        addTimeObs = dialog.findViewById(R.id.dateobs);
        addCmtObs = dialog.findViewById(R.id.commentObs);
        addButton = dialog.findViewById(R.id.add_obs);
        cancelBtn = dialog.findViewById(R.id.cancel_btn);

        addBtn = findViewById(R.id.add_obs_btn);
