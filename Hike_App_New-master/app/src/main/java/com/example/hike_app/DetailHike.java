...
public class DetailHike extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location = findViewById(R.id.destination_detail);
        length = findViewById(R.id.length_detail);
        date = findViewById(R.id.date_detail);
        level = findViewById(R.id.level_detail);
        parking = findViewById(R.id.parking_detail);
        description = findViewById(R.id.description_detail);
        edit = findViewById(R.id.btn_edit);
        delete = findViewById(R.id.btn_delete);
        obs = findViewById(R.id.btnObs);
